...
// Create Customers
const customers = [
    new Customer("Muhammad", "Ubaid", "Male", 19, 1234567890, accounts[0]),
    new Customer("Zohaib", "Wahab", "Male", 18, 9876543210, accounts[1]),
    new Customer("Abdul", "Muqeet", "Male", 20, 5555555555, accounts[2]),
];
